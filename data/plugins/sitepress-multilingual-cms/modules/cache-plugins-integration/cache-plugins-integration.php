                ...
                if(class_exists($this->plugin_cp_class) && method_exists($this->plugin_cp_class, 'clear_cache')){
                    ...
                    $ajx_request_exceptions = array(
                        ...
                        'icl_show_sidebar',
										...
										$request_get_icl_ajax_action = filter_input(INPUT_GET, 'icl_ajax_action', FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_NULL_ON_FAILURE);
										$request_post_icl_ajax_action = filter_input(INPUT_POST, 'icl_ajax_action', FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_NULL_ON_FAILURE);
                    if( ( ! $request_get_icl_ajax_action && ! $request_post_icl_ajax_action ) ||
												( !in_array($request_post_icl_ajax_action, $ajx_request_exceptions) && !in_array($request_get_icl_ajax_action, $ajx_request_exceptions) )
											){
