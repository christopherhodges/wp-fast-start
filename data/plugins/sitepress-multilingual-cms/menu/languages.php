                        ...
                        <form id="icl_save_language_negotiation_type" name="icl_save_language_negotiation_type" action="">
                            ...
                            <ul>
                                <?php
                                    ...
                                    $client = new WP_Http();
																		$request_post_url = filter_input(INPUT_POST, 'url', FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_NULL_ON_FAILURE);
                ...
                <form id="icl_save_language_switcher_options" name="icl_save_language_switcher_options" action="">
                    ...
                    <div class="wpml-section-content">
                        ...
                        <div class="wpml-section-content-inner">
                            ...
                            <?php 
														$request_get_icl_ls_reset = filter_input(INPUT_GET, 'icl_ls_reset', FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_NULL_ON_FAILURE);
