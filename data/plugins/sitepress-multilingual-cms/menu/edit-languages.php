...
class SitePress_EditLanguages {
	...
	function __construct() {
        ...
        $this->built_in_languages = array_values($lang_codes);
				...
				$request_get_action = filter_input(INPUT_GET, 'action', FILTER_SANITIZE_STRING, FILTER_NULL_ON_FAILURE);
				$request_get_id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
				$request_get_icl_nonce = filter_input(INPUT_GET, 'icl_nonce', FILTER_SANITIZE_STRING, FILTER_NULL_ON_FAILURE);
		...
		$this->get_active_languages();
			...
			// Trigger save.
		$request_post_icl_edit_languages_action = filter_input(INPUT_POST, 'icl_edit_languages_action', FILTER_SANITIZE_STRING, FILTER_NULL_ON_FAILURE);
		$request_post__wpnonce = filter_input(INPUT_POST, '_wpnonce', FILTER_SANITIZE_STRING, FILTER_NULL_ON_FAILURE);
